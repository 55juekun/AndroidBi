...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    private void findAllViews() {
        ...
        cutButton=findViewById(R.id.cut);
...
//全屏下的切换分辨率按钮监听
        ...
        recordButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnRecordClickListener != null) {
                    ...
                    mHideHandler.sendEmptyMessage(WHAT_HIDE);
                }
            }
        });
    }
    ...
    private void updateShowMoreBtn() {
        if (mAliyunScreenMode == AliyunScreenMode.Full) {
            ...
            mTitleDownload.setVisibility(GONE);
            cutButton.setVisibility(VISIBLE);
    ...
    public void setOnCutClickListener(OnCutClickListener listener){
